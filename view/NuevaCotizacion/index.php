                            ...
                            <div class="container-fluid py-0 px-0">
                                <div>
                                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                        ...
                                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Cotización</li>
                                    </ol>
                                    <h6 class="font-weight-bolder mb-0">Nueva Cotización<p><small>Creación y Registro de Cotizaciones</small></p></h6>
                                </div>
