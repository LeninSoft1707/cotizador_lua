                            ...
                            <div class="container-fluid py-0 px-0">
                                <div>
                                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                                        ...
                                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Categoría</li>
                                    </ol>
                                    <h6 class="font-weight-bolder mb-0">Categoría<p><small>Registro, Modificación y Eliminación de Categorias</small></p></h6>
                                </div>
                    ...
                    <div class="card my-2">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Mantenimiento de Categoría</h6>
                            </div>
                        </div>
                                ...
                                <table id="lista_data" class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Descripción</th>
                                            <th width="1%"></th>
                                            <th width="1%"></th>
                                        </tr>
                                    </thead>
